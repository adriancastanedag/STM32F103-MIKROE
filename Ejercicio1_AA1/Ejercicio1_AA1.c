...
1) Cambie los tiempos de conmutación del LED
  para ello se define una constante de reatardo en el apartado 2 de nuestro código
  #define RETARDO     700
  en el Delay_ms de mi función proceso se cambia la constante por la definición de retardo
  Delay_ms(RETARDO)
*/
